...
import { VerticalDividerMiddle, ThinVerticalDivider, HorizontalDividerMiddle2, HorizontalDividerMiddle1 } from "../../../Common/VerticalDivider";
...
const AboutComponent = () => {
  ...
  {/* About */}
      <TitleTypo variant="h4" style={{ color: isLightMode?'rgba(255,255,255,.55)':'black'}}>
        {Title1}
      </TitleTypo>
      <DividerLine />
      <Grid container alignItems="center" justifyContent="center" spacing={5}>
        ...
        md={4}
        >
          <Typography variant="body1" style={{ color: isLightMode?'rgba(255,255,255,.55)':'black',textAlign:'center' }} >
            {AboutText}
          </Typography>
        </Grid>
...
{/* My Services */}
      ...
      <Grid container alignItems="center" justifyContent="center" spacing={4}>
        <Grid item md={4} sx={12}>
          ...
          <SubTitleTypo variant="h4"  style={{ color: isLightMode?'rgba(255,255,255,.55)':'black'}}>
            {subTitle1.title}
          </SubTitleTypo>
          <Typography variant="body1" style={{ color: isLightMode?'rgba(255,255,255,.55)':'black'}}>
            {subTitle1.text}
          </Typography>
        </Grid>
      ...
      <TitleTypo variant="h4" sx={12} style={{ color: isLightMode?'rgba(255,255,255,.55)':'black'}}>
        {Title3}
      </TitleTypo>
      <DividerLine />
      <Grid container alignItems="center" justifyContent="center" spacing={2}>
